...
#[no_mangle]
pub extern "C" fn v8_gc_init(calls: *const V8_Upcalls, heap_size: usize) {
...
#[no_mangle]
pub extern "C" fn bind_mutator(tls: OpaquePointer) -> *mut SelectedMutator<V8> {
...
pub extern "C" fn alloc(mutator: *mut SelectedMutator<V8>, size: usize,
    ...
    memory_manager::alloc::<V8>(unsafe { &mut *mutator }, size, align, offset, allocator)
}
...
#[no_mangle]
pub extern "C" fn report_delayed_root_edge(trace_local: *mut SelectedTraceLocal<V8>, addr: Address) {
    memory_manager::report_delayed_root_edge(&SINGLETON, unsafe { &mut *trace_local }, addr)
}

#[no_mangle]
pub extern "C" fn will_not_move_in_current_collection(trace_local: *mut SelectedTraceLocal<V8>, obj: ObjectReference) -> bool {
    memory_manager::will_not_move_in_current_collection(&SINGLETON, unsafe { &mut *trace_local}, obj)
}

#[no_mangle]
pub extern "C" fn process_interior_edge(trace_local: *mut SelectedTraceLocal<V8>, target: ObjectReference, slot: Address, root: bool) {
...
pub extern "C" fn start_worker(tls: OpaquePointer, worker: *mut SelectedCollector<V8>) {
    memory_manager::start_worker::<V8>(tls, unsafe { worker.as_mut().unwrap() })
}
...
pub extern "C" fn trace_get_forwarded_referent(trace_local: *mut SelectedTraceLocal<V8>, object: ObjectReference) -> ObjectReference{
    memory_manager::trace_get_forwarded_referent::<V8>(unsafe { &mut *trace_local }, object)
}
...
pub extern "C" fn trace_get_forwarded_reference(trace_local: *mut SelectedTraceLocal<V8>, object: ObjectReference) -> ObjectReference{
    memory_manager::trace_get_forwarded_reference::<V8>(unsafe { &mut *trace_local }, object)
}
...
#[no_mangle]
pub extern "C" fn trace_root_object(trace_local: *mut SelectedTraceLocal<V8>, object: ObjectReference) -> ObjectReference {
    memory_manager::trace_root_object::<V8>(unsafe { &mut *trace_local }, object)
}

#[no_mangle]
pub extern "C" fn process_edge(trace_local: *mut SelectedTraceLocal<V8>, object: Address) {
    memory_manager::process_edge::<V8>(unsafe { &mut *trace_local }, object)
}

#[no_mangle]
pub extern "C" fn trace_retain_referent(trace_local: *mut SelectedTraceLocal<V8>, object: ObjectReference) -> ObjectReference{
    memory_manager::trace_retain_referent::<V8>(unsafe { &mut *trace_local }, object)
}

#[no_mangle]
pub extern "C" fn handle_user_collection_request(tls: OpaquePointer) {
    memory_manager::handle_user_collection_request::<V8>(&SINGLETON, tls);
}
