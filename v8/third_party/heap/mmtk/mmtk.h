...
// Does this have to be atomic?
std::atomic<bool> gc_in_progress(false);
v8::base::Mutex gc_mutex;
v8::base::ConditionVariable gc_condvar;
...
extern void* alloc(MMTk_Mutator mutator, size_t size, size_t align,
                   size_t offset, int allocator);

extern void* alloc_slow(MMTk_Mutator mutator, size_t size, size_t align,
                        size_t offset, int allocator);

extern void post_alloc(MMTk_Mutator mutator, void* refer, int bytes,
                       int allocator);
